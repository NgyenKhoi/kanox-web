            ...
            steps {
                dir('backend') {
                    ...
                    sh """
                        ...
                        scp -i ${SSH_KEY} ${REMOTE_USER}@${REMOTE_HOST}:/home/vunguyenkhoi47/kanox/secrets/application.properties src/main/resources/
                        scp -i ${SSH_KEY} ${REMOTE_USER}@${REMOTE_HOST}:/home/vunguyenkhoi47/kanox/secrets/gcp-secret-credentials.json src/main/resources/
                    """
