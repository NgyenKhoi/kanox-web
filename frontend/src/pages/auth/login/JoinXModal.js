...
const JoinXModal = ({ show, handleClose, onShowLoginModal }) => {
  const [showCreateAccountModalFromJoinX, setShowCreateAccountModalFromJoinX] = useState(false);
  ...
  const handleCloseCreateAccountModalFromJoinX = () => setShowCreateAccountModalFromJoinX(false);
          ...
          >
            ...
            <div className="d-flex flex-column gap-3 mx-auto" style={{ maxWidth: "300px" }}>
              ...
              <p className="text-muted small mt-2 text-center">
                ...
                <a href="#" className="text-decoration-none" style={{ color: "#1A8CD8" }}>
                  Điều khoản Dịch vụ
                </a>{" "}
                và{" "}
                <a href="#" className="text-decoration-none" style={{ color: "#1A8CD8" }}>
