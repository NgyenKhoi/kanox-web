    ...
    return (
        ...
        >
          ...
          <div className="text-sm">
            <p className="font-bold text-[var(--text-color)]">{item.displayName || item.username}</p>
            <p className="text-gray-500">@{item.username}</p>
            {item.bio && <p className="text-gray-500">{item.bio.slice(0, 100)}...</p>}
          </div>
        </div>
    );
  };
            ...
            trendingTopics.map((topic) => (
                ...
                >
                  <div>
                    ...
                    <p className="font-bold text-[var(--text-color)]">{topic.title}</p>
