                    ...
                    {loading ? (
                        ...
                        <>
                            {(topReactions.length + otherReactions.length > 1) && (
                                <div className="d-flex align-items-center gap-2 flex-wrap mb-3 ps-3 pe-3">
                                    <Button
                                        variant="link"
                                        className={`p-1 rounded-pill fw-semibold ${selectedReaction === null ? 'text-primary' : 'text-muted'}`}
                                    ...
                                    {otherReactions.length > 0 && (
                                        <Dropdown align="end">
                                            <Dropdown.Toggle
                                                variant="link"
                                                className="p-1 rounded-circle fs-5 text-muted"
                                            >
                                                ...
                                            </Dropdown.Toggle>
                                            <Dropdown.Menu>
