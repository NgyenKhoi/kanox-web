...
const KLogoSvg = ({ className = "w-100 h-100", fill = "currentColor" }) => {
  return (
    <svg
      ...
      width="500.000000pt"
      height="500.000000pt"
      viewBox="0 0 500.000000 500.000000" // Đã cập nhật viewBox theo SVG bạn cung cấp
      preserveAspectRatio="xMidYMid meet"
      aria-hidden="true"
      className={className}
      fill={fill} // Sử dụng prop fill để có thể thay đổi màu từ bên ngoài
      stroke="none" // Đảm bảo không có viền mặc định nếu không mong muốn
    >
