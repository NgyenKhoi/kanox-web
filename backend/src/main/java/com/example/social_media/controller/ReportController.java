...
public class ReportController {
    ...
    public ResponseEntity<?> updateReportStatus(
        ...
        try {
            ...
            return ResponseEntity.ok(Map.of("message", "Cập nhật trạng thái báo cáo thành công"));
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body(Map.of("status", "error", "message", "Lỗi khi cập nhật trạng thái báo cáo: " + e.getMessage(), "errors", Map.of()));
        }
    }
